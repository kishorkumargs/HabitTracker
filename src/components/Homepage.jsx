...
export default function Homepage({ onGetStarted }) {
  ...
  return (
    <div className="relative w-full min-h-screen">
      ...
      {/* Content */}
      <div className="relative z-10 min-h-screen bg-gradient-to-br from-slate-50/90 via-white/90 to-slate-100/90 dark:from-slate-950/90 dark:via-slate-900/90 dark:to-slate-950/90 text-gray-900 dark:text-slate-100">
        <ClickSpark
